...
if [ ! -f ".requirements" ]; then
    ...
    {
        sudo apt update
        sudo apt install -y rsync kmod git device-tree-compiler lz4 xz-utils zlib1g-dev openjdk-17-jdk gcc g++ python3 python-is-python3 p7zip-full android-sdk-libsparse-utils erofs-utils
    } && touch .requirements
fi
